          ...
          <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-blue-700 via-indigo-700 to-slate-900 p-10 shadow-2xl">
            ...
            <div className="relative">
              ...
              <h1 className="mt-6 max-w-4xl text-5xl font-bold leading-tight text-white">
                Your dataset has been transformed into actionable business
                intelligence.
              </h1>
              ...
              <p className="mt-5 max-w-3xl text-lg leading-8 text-blue-100">
                ...
                discovered trends, built executive dashboards and prepared
              ...
              <div className="mt-10 grid gap-5 md:grid-cols-3">
                ...
                <div className="rounded-2xl border border-white/15 bg-white/10 p-5 backdrop-blur-xl transition-all duration-300 hover:bg-white/15">
                  <BrainCircuit
